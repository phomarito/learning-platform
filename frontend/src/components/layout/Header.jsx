    ...
    return (
        <header className="sticky top-0 z-10 flex items-center justify-between h-16 px-4 md:px-8 bg-white border-b border-gray-200">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="w-10 h-10 bg-gradient-to-br from-primary to-purple-700 rounded-full flex items-center justify-center text-white font-medium cursor-pointer">
